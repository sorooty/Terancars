    ...
    <header class="header">
        <nav class="nav-main container">
            ...
            <div class="nav-auth">
                ...
                <a href="<?= url('public/pages/auth/inscription.php') ?>" class="btn btn-secondary active">Inscription</a>
            </div>
        </nav>
    </header>
        ...
        <div class="auth-container">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (empty($name) || empty($phone) || empty($email) || empty($password)) {
                    echo '<div class="auth-message error">Tous les champs sont obligatoires</div>';
                } else {
                    // TODO: Ajouter la logique d'inscription
                    echo '<div class="auth-message success">Inscription réussie !</div>';
                }
            }
            ?>
            <form method="POST" action="" class="auth-form">
                ...
                <div class="auth-links">
                    <p>Vous avez déjà un compte ? <a href="<?= url('public/pages/auth/login.php') ?>">Connectez-vous !</a></p>
                </div>
            </form>
        </div>
    </main>
